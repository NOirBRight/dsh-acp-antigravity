window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_6a4ff081aae124b5a881cae2c254af6c/node_modules/dsh-llm-providers-ui/lib/model-catalog.js
		const inputStyle = {
		...
		*/
		...
		function ModelCatalogEditor(props) {
			...
			return (0, react_jsx_runtime.jsx)(SortableList, {
				items: [...items],
				...
				renderItem: (model, index) => {
					...
					return (0, react_jsx_runtime.jsxs)("div", {
						...
						"data-provider-model": "",
						style: catalogStyles.modelContentStyle,
						children: [
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_6a4ff081aae124b5a881cae2c254af6c/node_modules/dsh-llm-providers-ui/lib/provider-ui.js
		/**
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_6a4ff081aae124b5a881cae2c254af6c/node_modules/dsh-llm-providers-ui/lib/usage-readers.js
		...
		*/
		function catalogOverrideFlags(model, baseline) {
			...
			const changed = (field, differs) => {
				if (differs) flags[field] = true;
			};
		...
		*/
		function AntigravityCardBody({ t, row, snapshot, state, quota, quotaError, quotaLoading, working, polling, saving, dirty, onAction, onRefresh, onRefreshModels, onRefreshQuota, onCatalogChange, onPersist, onDiscard, accessKind }) {
			...
			const patchModel = (index, patch) => {
				...
				onCatalogChange(row.models.map((model, at) => {
					...
					const updated = {
						...
						...next.overrides === void 0 ? {} : { overrides: next.overrides }
					};
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", {
								...
								style: muted,
								children: row.authenticated ? t("connected") : state === "missing" ? t("missingBadge") : t("authBadge")
				...
				state === "connected" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
					...
					children: [
						...
						catalogOpen ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ModelCatalogEditor, {
							items: drafts,
							fields: {
								vision: true,
								thinking: true,
