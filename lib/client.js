window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/@deepseek-ai+dsh-acp-provider@https+++github.com+NOirBRight+dsh-acp-provider+releases+d_c2dd59ab168ab8a624c116e2a300cd0a/node_modules/@deepseek-ai/dsh-acp-provider/dist/native-history.js
		...
		*/
		...
		async function loadActivityPage(rpc, sessionId, afterSeq, signal) {
			const result = await rpc.call(ACP_SETTINGS_RPC_CHANNEL, ACTIVITY_READ_AFTER_ENDPOINT, {
				sessionId,
				afterSeq
			}, signal);
			if (!result.ok) {
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/@deepseek-ai+dsh-acp-provider@https+++github.com+NOirBRight+dsh-acp-provider+releases+d_c2dd59ab168ab8a624c116e2a300cd0a/node_modules/@deepseek-ai/dsh-acp-provider/dist/native-ui.js
		const TOOL_PRESENTATION = {
			...
			todo_write: {
				...
				icon: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChecklistOutline14, { size: 14 })
			},
			bash: {
			...
			web_fetch: {
				...
				icon: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconGlobeOutline14, { size: 14 })
			},
			write: {
		...
		function iconOf(toolName) {
			return TOOL_PRESENTATION[toolName]?.icon ?? (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconSparkle16, { size: 14 });
		}
				...
				case "diff":
					body = (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.DiffBlock, {
						...
						labels: {
							...
							files: (count) => props.t(count === 1 ? "diff.files.one" : "diff.files.other", { count })
						}
					});
					break;
				case "terminal":
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_7ccd86851701f1aa038d88c4dfcbf1df/node_modules/dsh-llm-providers-ui/lib/model-catalog.js
		const inputStyle = {
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_7ccd86851701f1aa038d88c4dfcbf1df/node_modules/dsh-llm-providers-ui/lib/provider-ui.js
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_7ccd86851701f1aa038d88c4dfcbf1df/node_modules/dsh-llm-providers-ui/lib/usage-readers.js
		/** Plain-object guard shared by the reader factories and the sidebar cache validator. */
