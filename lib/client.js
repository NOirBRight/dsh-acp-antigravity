	...
	factory: (require) => {
		...
		function decodeQuotaSnapshot(value) {
			...
			for (const group of value.groups) {
				if (!isRecord(group) || !Array.isArray(group.buckets)) return void 0;
				const buckets = [];
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@file+.stage+dsh-llm-providers-ui-0.1.10.tgz_@deepseek-ai+cordis@4._ceb764a3c9896b516fd1def8f27180f1/node_modules/dsh-llm-providers-ui/lib/provider-ui.js
		/**
