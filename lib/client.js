window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		async function loadActivityRows(rpc, sessionId, signal) {
		...
		*/
		...
		function AntigravityToolNode({ row, t }) {
			...
			const child = state.name === SPAWN_TITLE ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				style: { color: "var(--dsw-alias-label-tertiary)" },
				children: t("activityChildUnknown")
			}) : null;
			const link = state.location === void 0 ? null : state.location.kind === "url" && /^https?:\/\//u.test(state.location.target) ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("a", {
				style: {
					color: "var(--dsw-alias-label-primary)",
					overflowWrap: "anywhere"
				},
				href: state.location.target,
				target: "_blank",
				rel: "noreferrer",
				children: state.location.target
			...
			if (state.input === void 0 && link === null && child === null && detail === void 0 && !terminal) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("section", {
				style: rowStyle,
				"aria-label": label,
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("time", {
							...
							children: new Date(row.time).toLocaleString()
						})
					]
				})
			});
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("section", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("summary", {
						...
						style: bodyStyle,
						children: [
							state.input === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("pre", {
								style: commandStyle,
								children: state.input
							}),
							link,
							child,
							detail === void 0 ? terminal ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: { color: "var(--dsw-alias-label-tertiary)" },
		...
		*/
		...
		function NativeTurnContainer(props) {
			...
			if (rows.length === 0 && history.error === void 0) return null;
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					rows.map((row) => {
						const unattributed = !isOwnedByTurn(Date.parse(row.firstSeenAt), startMs, endMs);
						...
						}) : null, /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AntigravityToolNode, {
							row,
							t: props.t
						})] }, row.key);
					}),
