	...
	factory: (require) => {
		...
		*/
		function AntigravityCardBody({ t, row, snapshot, state, quota, quotaError, quotaLoading, working, polling, saving, dirty, onAction, onRefresh, onRefreshModels, onRefreshQuota, onCatalogChange, onPersist, onDiscard, accessKind, mode, detailCopy, sharedTemplate, sharedUsage, onSharedQuotaRefresh }) {
			...
			if (mode === "detail" && sharedTemplate !== void 0 && detailCopy !== void 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(sharedTemplate, {
				name: "Antigravity",
				role: "agent",
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				...
				state === "connected" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ModelPickerDialog, {
							open: picker,
							loading: fetching,
