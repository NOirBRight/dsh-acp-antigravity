	...
	factory: (require) => {
		...
		*/
		function foldAgentTextRecords(records) {
			...
			for (const record of records) {
				...
				if (record.type !== "antigravity/agent-text") continue;
				rows.push({
					key: String(record.seq),
					epoch,
					firstSeenAt: record.time,
		...
		*/
		function foldActivityRecords(records) {
			...
			for (const record of records) {
				...
				if (record.type === "antigravity/agent-observed" || record.type === "antigravity/agent-text" || record.type === "antigravity/user-question-answer" || record.type === "antigravity/full-access-authorized" || record.type === "antigravity/request-telemetry" || record.type === "antigravity/usage-snapshots") continue;
		...
		*/
		...
		const nativeTurnDefinition = {
			...
			match: (event) => {
				...
				if (event.type === "turn/end" || event.type === "step/start" || event.type === "assistant/chunk" || event.type === "assistant/message") return {
					id,
					role: "update"
				};
				return null;
		...
		*/
		...
		function anchorOf(context) {
			...
			for (const match of context.matches) {
				...
				if (match.event.type === "assistant/chunk" && chunk === void 0) chunk = next;
		...
		//#endregion
		//#region src/web/AntigravityReadonlyCard.tsx
		function AntigravityReadonlyCard({ callId, toolName, nativeName, block, t }) {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								"data-card-status": state,
								children: status
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								"data-card-tool": toolName,
								children: toolName
							}),
							renamed ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								"data-card-native-name": nativeName,
								style: { color: "var(--dsw-alias-label-tertiary)" },
								children: nativeName
							}) : null
						]
					}),
					args === "" ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						"data-card-args": args,
						style: {
							whiteSpace: "pre-wrap",
							color: "var(--dsw-alias-label-secondary)"
						},
						children: flattenArgsText(args)
					}),
					!settled ? null : result === "" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						"data-card-empty-result": true,
						style: { color: "var(--dsw-alias-label-tertiary)" },
						children: t("activityNoOutput")
					}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						"data-card-result": failed ? "error" : "ok",
		...
		function flattenArgsText(argsRaw) {
			let parsed;
			try {
		...
		*/
		...
		function AntigravityToolNode({ row, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AntigravityReadonlyCard, {
				callId,
				toolName,
				nativeName,
				block,
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@file+..+..+..+..+.dsh-lab+tmp+dsh-llm-providers-ui-0.1.12-preview._0ef0ed78c14a47751f675fabd7726490/node_modules/dsh-llm-providers-ui/lib/model-catalog.js
		const inputStyle = {
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@file+..+..+..+..+.dsh-lab+tmp+dsh-llm-providers-ui-0.1.12-preview._0ef0ed78c14a47751f675fabd7726490/node_modules/dsh-llm-providers-ui/lib/provider-ui.js
		/**
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@file+..+..+..+..+.dsh-lab+tmp+dsh-llm-providers-ui-0.1.12-preview._0ef0ed78c14a47751f675fabd7726490/node_modules/dsh-llm-providers-ui/lib/provider-detail.js
		...
		function formatResetLabel(resetsAt, period, copy) {
			const instant = formatResetInstant$1(resetsAt);
			if (instant !== void 0) return ((copy === void 0 ? "" : instant.overdue ? copy.overdue : copy.at) + instant.when + " · " + instant.relative).replace(/^ · /, "");
			if (nonEmptyString$1(resetsAt) && /reset|重置/iu.test(resetsAt)) return resetsAt;
...
`;
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@file+..+..+..+..+.dsh-lab+tmp+dsh-llm-providers-ui-0.1.12-preview._0ef0ed78c14a47751f675fabd7726490/node_modules/dsh-llm-providers-ui/lib/usage-readers.js
		...
		*/
		function antigravityModelCount() {
		...
		*/
		function AntigravityCardBody({ t, row, snapshot, state, quota, quotaError, quotaLoading, working, polling, saving, dirty, onAction, onRefresh, onRefreshModels, onRefreshQuota, onCatalogChange, onPersist, onDiscard, accessKind, mode, detailCopy, sharedUsage, onSharedQuotaRefresh }) {
			...
			const installBlock = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				style: section,
				children: [
					"      ",
			...
			if (mode === "detail") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ProviderDetail, {
				name: "Antigravity",
				role: "agent",
				...
				state === "connected" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
					...
					children: [
						...
						quota?.groups.map((group, gi) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", {
							...
							children: group.buckets.map((bucket, bi) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ProviderQuotaMeter$1, {
								label: bucket.displayName ?? bucket.window ?? t("quota"),
								...bucket.disabled || bucket.remainingFraction === void 0 ? {} : { remainingPercent: bucket.remainingFraction >= 1 ? 100 : Math.min(99, Math.round(bucket.remainingFraction * 100)) },
		...
		*/
		function ExternalAgentsSection({ t, load, save, run, quota: readQuota, ...slot }) {
			...
			const liveQuota = first === void 0 ? void 0 : {
				remainingPercent: first.bucket.remainingFraction >= 1 ? 100 : Math.min(99, Math.round(first.bucket.remainingFraction * 100)),
				label: [first.group, first.bucket.window ?? first.bucket.displayName].filter(Boolean).join(" · "),
				...quotaError === void 0 ? resetDetail === void 0 ? {} : { detail: resetDetail } : { detail: t("staleQuota") }
			};
			...
			if (slot.mode === "detail" && row && snapshot) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				"data-provider-card": "antigravity",
				"data-provider-role": "agent",
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("style", { children: providerUiCss + localCss }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AntigravityCardBody, {
					t,
					row,
					snapshot,
					state,
