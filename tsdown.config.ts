...
const PACKAGE_ID = '@deepseek-ai/dsh-acp-antigravity'
...
const client: UserConfig = {
  ...
  clean: false,
  deps: {
    alwaysBundle: ['@deepseek-ai/dsh-acp-provider', 'dsh-llm-providers-ui/provider-ui', 'dsh-llm-providers-ui/usage-readers'],
    neverBundle: [
      'react',
      'react/jsx-runtime',
      'react-dom',
