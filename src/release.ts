/** Pinned Google ACP Registry release. Hashes match T3 / registry as of 2026-09-02. */

export const ANTIGRAVITY_RELEASE_VERSION = 'agy_acp_server_20260818_01_RC01'

/** One platform zip from dl.google.com. */
...
const assets = new Map<string, AntigravityReleaseAsset>([
  ['darwin-arm64', {
...
/** Resolve the pinned Google zip for this host. */
export function resolveAntigravityReleaseAsset(platform: NodeJS.Platform = process.platform, arch: string = process.arch): AntigravityReleaseAsset | undefined {
  return assets.get(platform + '-' + arch)
}
