...
for (const id of imports) {
  assert(id.startsWith('@deepseek-ai/dsh-client-') || ['@deepseek-ai/cordis', 'react', 'react/jsx-runtime', 'react-dom', 'react-dom/client'].includes(id), `Non-platform client dependency must be bundled: ${id}`)
}
